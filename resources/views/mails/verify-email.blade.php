          ...
          <tr>
            <td bgcolor="#fff">
              <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td style="padding: 10px 20px 10px 20px; font-family: Nunito, sans-serif; font-size: 20px; font-weight:500;margin-left:25px;">
                    Hola!
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td style="padding: 20px 0 20px 0; font-family: Nunito, sans-serif; text-align: center;">
                    <a style="background-color: #a998f6; border: none; color: white; padding: 15px 40px; text-align: center; display: inline-block; font-family: Nunito, sans-serif; font-size: 13px; font-weight: bold; cursor: pointer;" target="_blank" href="{{ $actionUrl }}">
