      ...
      <ul class="nav navbar-nav align-items-center ms-auto ">
        <li class="nav-item dropdown dropdown-language " >
          <a class="nav-link dropdown-toggle" id="dropdown-flag" href="#" data-bs-toggle="dropdown" aria-haspopup="true">
            ...
            <span class="selected-language text-white">ESPAÑOL</span>
          </a>
          {{----}}
        ...
        <li class="nav-item dropdown dropdown-notification me-25">
          <a class="nav-link" href="javascript:void(0);" data-bs-toggle="dropdown">
            <i class="ficon text-white" data-feather="bell"></i>
        ...
        <li class="nav-item dropdown dropdown-user">
          <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-bs-toggle="dropdown" aria-haspopup="true">
            <div class="user-nav d-sm-flex d-none">
              <span class="user-name fw-bolder text-white">{{Auth::user()->name}} {{Auth::user()->lastname}}</span>
            ...
            <span class="avatar">
              ...
              @else
                <span class="avatar-status-offline" style="background-color: #EBAAFF"></span>
              @endif
            </span>
          </a>
