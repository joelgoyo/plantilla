...
<div class="auth-wrapper auth-v1 px-2">
    <div class="auth-inner py-2">
        <div class="card mb-0 p-2" style="border: 2px solid #2d3336;opacity:0.8; background-color:black;">
            <div class="card-body">
                <a href="#" class="brand-logo">
                    <img src="{{asset('Dashboard/IMAGOEXCELESIOR-19/IMAGOEXCELESIOR-19.png')}}" alt="">
                </a>

                <h2 class="rosado text-center" style="font-weight:bold;letter-spacing:4px;">LOGIN</h2>

                <form class="auth-login-form mt-3" method="POST" action="{{ route('login') }}">
                    @csrf
                    ...
                    <div class="mb-1">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{ route('password.request') }}">
                                <small class="rosado" style="font-weight: 800;">Has olvidado tu contraseña?</small>
                            </a>
                            @endif
                        </div>
                    ...
                    <button type="submit" class="btn w-100 rosado Referral-btn" tabindex="4" style="font-weight:bold;">iniciar sesión</button>
                </form>

            </div>
            <div class="row">
                <div class="col-auto me-auto"><span class="btn">Don't have an account yet? @if (Route::has('register'))
                    <a href="{{ route('register') }}">
                        <span class="rosado fw-bold">Registrate</span>
                    </a>
                @endif
                </span>
                </div>
